...
class Player:
    ...
    def get_player_turn(self):
        """atgriez pagrieziena atribūta vērtību
"""
        return self.turn

    def check_for_victory(self, board, main_display):
        """parbauda, vai spēlētājs ir uzvarējis, un ja tā, izsauc Display klases uzvaras animācijas metodi.

        :param board:  board datu struktura
        :param main_display: objekta of display class
        """
    ...
    def is_piece_attacked(self, board):
        """parbauda vai spleeteja ir uzbrucis vina piece un parbauda True or False."""
        all_attacks = []
    ...
    def select_player_with_turn(cls, player1, player2):
        """Atgriež Spēlētāja klases objektu ar pagrieziena atribūtu, kas tam ir līdzvērtīgs
    ...
    def switch_turns(self, player1, player2):
        """Pārslēdz divu Spēlētāja klases objektu pagriezienu atribūtus."
    ...
    def get_moves_of_piece(self, board, posy, posx):
        """atgriez 4 vai 5 vienumus atkarībā no uzbrukuma ar dambretes koordinātām kā pārvietošanās pozīcijas. """
        piece_moves = []
        piece_attacks = []
    ...
    def get_ply(self, board):
        """parbauda lai saņemtu_moves_of_piece par katru spēlētāja īpašumā esošo piece uz lauka."""
