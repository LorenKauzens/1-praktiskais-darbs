...
class Computer:
    ...
    # parbauda gabala vērtību, pamatojoties uz tā pozīciju, dodot priekšroku veicināšanas malām kas ir def tiesi leja
    ...
    # parbauda gabala vērtību, pamatojoties uz tā pozīciju, dodot priekšroku vertikālām apmalēm
    ...
    # parbauda visas checker vērtību, summējot visu gabalu vērtības
    ...
    # tiek imznatota  alfa-beta funkcija, lai atrastu datoram piemērotāko kustību
